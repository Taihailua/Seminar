...
|--------|----------------------|-------------------|-----------------------------------------------------------------------------------------------|
| POST   | `/api/auth/register` | Đăng ký tài khoản | `multipart/form-data`: `email`\*, `password`\*, `name`\*, `language`\*, `avatar` (tùy chọn)  |
...
| Method | Endpoint                                                         | Mô tả                           | Body                          |
|--------|------------------------------------------------------------------|---------------------------------|-------------------------------|
| GET    | `/api/restaurant-script-map/:id_restaurant`                      | Lấy tất cả script của nhà hàng  | —                             |
